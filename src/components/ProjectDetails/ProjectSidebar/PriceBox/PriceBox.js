      ...
      <div>
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col">
            ...
            <span>
              <b className="text-3xl font-inter-bold mr-2 unlock-text">
                $491,400
              </b>
            </span>
          </div>
          <div className="flex flex-col">
            ...
            <div className="allocation-details-text">
              <span>
                <b className="font-inter-bold mr-2 unlock-text">
                  {" "}
              ...
              <span>
                <b className="font-inter-bold mr-2 unlock-text">
                  {parseFloat(myEthAmount).toFixed(2)}
                </b>
              </span>
            </div>
            <div className="allocation-details-text space-end">
              <span>
                <b className="font-inter-bold mr-2 unlock-text sera-count">
                  <img
                    src={SynceraIcon}
                    className="syncera-token-icon"
                    alt=""
                  />{" "}
