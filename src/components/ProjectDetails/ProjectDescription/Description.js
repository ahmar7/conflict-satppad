...
const Description = () => {
  ...
  const onPurchase = async () => {
    ...
    try {
      if (
        ethAmount < 0.001 ||
        parseFloat(ethAmount) + parseFloat(myEthAmount) > 10
      ) {
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2 mb-30px last:mb-0">
                      ...
                      <p className="text-paragraph-text text-sm leading-[26px] mb-2 last:mb-0 project-content">
                        ...
                        decentralized finances. The platform will offer all the
                        necessary tools to make investing in the zkSync
            ...
            <div>
              <div>
                <div className="flex justify-center items-center flex-col access-private-section">
                  ...
                  <span className="block w-full text-sm text-paragraph-text mb-5 leading-[26px] whitelist-instructions">
                    During the first hour of the private sale, only whitelisted
                    addresses will have <i>priority</i> access, while the
                    general public will be admitted on a first-come,
                    first-served (FCFS) basis for the remainder of the sale.
                  </span>
                  <span className="block w-full text-sm text-paragraph-text mb-5 leading-[26px] whitelist-instructions">
                    <b>
                  ...
                  <span className="block w-full text-sm text-paragraph-text mb-5 leading-[26px] whitelist-instructions">
                    The deadline to register your wallet is on{" "}
                    <i>Sunday 14 May, 2:00 PM UTC</i>. About 24 hours before the
                    sale, you can connect your wallet to confirm your
                    qualification for the whitelist.
                  </span>
                  <div className="w-60">
                    <a
                ...
                <div className="flex justify-center items-center flex-col">
                  <div className="flex flex-col bg-opacity-25 rounded-md w-full px-5 py-3 mb-9 text-sm text-center border-orange-500 bg-orange-300 text-orange-600">
                    {!wallet.account ? (
                      <span>
                        {" "}
                        Please connect your wallet before you can view the
                        project sale.{" "}
                      </span>
                    ) : isWhitelisted ? (
                      <div className="flex justify-center items-center">
                        ...
                        >
                          ...
                          <div className={alertClass}>
                            <span
                              data-v-18811a9f
                              className="new-calc-sub-header"
                            >
                              <i class="fas fa-coins"></i>{" "}
                              <span className="ml-1">
                                Your Allocation: <i>10 ETH</i>
                              </span>
                            </span>
                          </div>
                          ...
                          <div
                            data-v-18811a9f
                            className="calc-container inputs"
                          >
                          ...
                          <div
                            data-v-18811a9f
                            className="calc-container lock-time"
                          >
                            <div
                              data-v-18811a9f
                      ...
                      <div>Sorry, You are not whitelisted.</div>
                    )}
                  </div>
                  <div className="w-60">
                    {/* <ConnectedWallet /> */}
