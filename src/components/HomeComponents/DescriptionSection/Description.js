...
import Feature2 from "../../../assets/img/introducing-satopad.png";
        ...
        <div className=" liREcv  iYGvXj  dkXQFz">
          <div className=" gCcOPY  hJcZlk  cYolYl">
            <div className=" fYUrZj  lhAFlZ  gVhNTd">
              <h2 className=" cfrnQw  bHSmrD">Get to Know SatoPAD</h2>
            </div>
          </div>
        </div>
          ...
          <button type="button" className=" no-border leEJeg btn-no-click">
            <div className=" frFRbQ">
              <h2 className=" dGTfCo  jfRZuw">
                ...
                */}
                DeFi Solutions for Bitcoin
              </h2>
              <p className=" ergcSf hOLKbL">
                <span>
                  <span>
                    <span>
                      SatoPAD's objective goes beyond serving solely as a
                      launchpad platform for Bitcoin. It is creating a
          ...
          <div className=" fYUrZj  ykcDz 0 cJebuI">
            ...
            >
              <h2 className=" kSxSwY  kFGeBv">
                Introducing SatoPAD Finance | The Premier Decentralized IDO Platform
                on Bitcoin
              </h2>
              <span className="rotate-bg">
                <img
            ...
            >
              <h2 className=" kSxSwY   kFGeBv">
                What are the key features and functions of the SatoPAD IDO
                launchpad?
              </h2>
              <span className="rotate-bg">
                <img
