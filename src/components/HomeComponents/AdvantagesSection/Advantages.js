          ...
          <div className="DoubleText  justify-content-between row">
            <div className="DoubleText-Item col-lg-6">
              ...
              <p className="DoubleText-Item--Top--Para">
                SatoPAD's IDO launchpad is a fundraising platform that operates on the Bitcoin blockchain, providing SATO holders with an equitable opportunity to engage in the most sought-after presales in a rapidly expanding ecosystem. You can stake your tokens, trade on our DEX, participate in our governance, and become part of our dynamic and thriving community.
              </p>
              <p className="DoubleText-Item--Top--Para primary-color">    
                  <b>We will provide all the necessary tools to make investing in the Bitcoin ecosystem more accessible, user-friendly, and inclusive while keeping security intact.</b>
              </p>    
            ...
            <div className="DoubleText-Item col-lg-5">
              ...
              <p className="DoubleText-Item--Top--Para">
                As a launchpad platform for Bitcoin, the team's unique requirements should be prioritized during the fundraising process, rather than being an afterthought. This is a crucial aspect of a project's journey as it sets the tone for their relationship with the community.
              </p>
              <p className="DoubleText-Item--Top--Para primary-color font-weight-bold">
                SatoPAD is committed to ensuring that teams receive the necessary support, creating a positive and fair environment that fosters strong momentum for the project.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="PageProtocol">
            <div className="PageProtocol-Item">
              ...
              <p className="PageProtocol-Item--Top--Para">
                Our goal is to build a strong community where all participants have a voice and can benefit from the growth of the Bitcoin ecosystem. 
              </p>
            </div>
            <div className="PageProtocol-Item">
              <div className="PageProtocol-Item--Top">
            ...
            <div className="PageProtocol-Item">
              <div className="PageProtocol-Item--Top">
                <h2 className="PageProtocol-Item--Top--Title">
                  <img src={HeartIcon} height="30px" className="icon-distance" />
                  Investor Protection
                </h2>
              </div>
              <p className="PageProtocol-Item--Top--Para">
                The community is given the freedom to vote on the projects that should be launched on SatoPAD, and the funds are allocated according to the performance of the project token.
              </p>
            </div>
          </div>
        </div>
